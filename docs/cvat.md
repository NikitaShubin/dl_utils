# Модуль обработки датасетов CVAT [`cvat.py`](../cvat.py)

Предоставляет комплекс инструментов для работы с датасетами CVAT (Computer Vision
Annotation Tool). Реализованы функции чтения, обработки, преобразования и визуализации
данных разметки с особым акцентом на полигональные аннотации как наиболее универсальный
формат.
