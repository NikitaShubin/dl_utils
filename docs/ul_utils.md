...
Содержит обёртки для работы с моделями библиотеки Ultralytics (YOLO, RT-DETR и др.), обеспечивающие удобный инференс и преобразование результатов в различные форматы.

Основной фокус сделан на задачах детекции, сегментации и трекинга объектов с поддержкой различных режимов вывода.
