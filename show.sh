...
# Основные константы:
      secsm=$((    3))  # Пауза в секундах между обновлениями
  oldnessth=$((    0))  # Не отображать файлы старше этого срока
  num_lines=$((   40))  # Число последних строк файла, выводимых на экран
