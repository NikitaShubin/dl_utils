...
class TestUltralyticsModel(unittest.TestCase):
    ...
    def test_init_with_model_name_only(self) -> None:
        """Тест инициализации только с именем модели."""
        with (
            patch('pathlib.Path.is_file') as mock_is_file,
            patch('pathlib.Path.home') as mock_home,
            patch('ul_utils.YOLO') as mock_yolo_class,
        ):
            mock_yolo_class.return_value = self.mock_yolo
    ...
    def test_init_with_string_and_kwargs(self) -> None:
    ...
    def test_init_with_yolo_object(self) -> None:
    ...
    def test_init_with_yolo_object_and_kwargs(self) -> None:
    ...
    def test_init_invalid_model_type(self) -> None:
        ...
        with patch('ul_utils.YOLO') as mock_yolo_class:
            ...
            with patch('ul_utils.isinstance') as mock_isinstance:
                ...
                assert (
                    'экземпляром класса' in error_msg
                    or 'зкземпляром класса' in error_msg
                )
    ...
    def test_init_with_different_modes(self) -> None:
    ...
    def test_img2df(self) -> None:
        """Тест метода img2df."""
        with (
            patch('ul_utils._result2objs') as mock_result2objs,  # noqa: F841
            patch('ul_utils.YOLO') as mock_yolo_class,
        ):
            mock_yolo_class.return_value = self.mock_yolo
    ...
    def test_img2df_with_tracking(self) -> None:
    ...
    def test_draw(self) -> None:
        ...
        with patch('ul_utils.YOLO') as mock_yolo_class:
            ...
            with tempfile.NamedTemporaryFile(suffix='.pt', delete=False) as tmp:
                ...
                model = UltralyticsModel(str(tmp_path))
                mock_result = MagicMock()
                mock_result.plot.return_value = np.zeros(
                    (100, 100, 3),
                    dtype=np.uint8,
                )
                model._img2result = MagicMock(return_value=mock_result)  # noqa: SLF001
    ...
    def test_call_preannotation_mode(self) -> None:
    ...
    def test_call_preview_mode(self) -> None:
    ...
    def test_call_invalid_mode(self) -> None:
    ...
    def test_result2df_with_bbox(self) -> None:
    ...
    def test_result2df_with_mask(self) -> None:
    ...
    def test_result2df_no_objects(self) -> None:
    ...
    def test_result2df_with_postprocess_filters(self) -> None:
    ...
    def test_video2subtask(self) -> None:
...
class TestUltralyticsModelIntegration(unittest.TestCase):
    ...
    def test_full_pipeline_no_detections(self) -> None:
        """Тест полного пайплайна без детекций."""
        with (
            patch('ul_utils._result2objs') as mock_result2objs,
            patch('ul_utils.YOLO') as mock_yolo_class,
        ):
            mock_yolo = MockYOLO()
    ...
    def test_frame_counter_increment(self) -> None:
